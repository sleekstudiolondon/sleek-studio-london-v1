  ...
  return (
    <section className="maison2-page maison2-home" aria-labelledby="maison2-home-title">
      ...
      <div className="maison2-focus-selector">
        ...
        <div className="maison2-focus-copy"><p className="maison2-kicker">Studio focus</p><h2>{focus.label}</h2><p>{focus.copy}</p><button type="button" onClick={() => selectTab(focus.label === "Hospitality" ? "hospitality" : focus.label === "Atelier" ? "atelier" : "residences")}>Explore {focus.label}</button></div>
