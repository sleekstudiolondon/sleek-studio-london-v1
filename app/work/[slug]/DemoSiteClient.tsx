...
function ContactPanel({ site }: { site: CaseStudy }) {
  ...
  const scopeLabel = site.slug === "maison-form" ? "Private residence, hospitality, or atelier scope" : "Project scope";
      ...
      >
        <div className="demo-form-grid">
          ...
          <label>
            ...
            <input name="location" type="text" placeholder="London, Paris, country house…" required />
          </label>
          <label>
            ...
            <select name="projectType" required defaultValue="">
              ...
              <option>Single room or apartment</option>
              <option>Renovation support</option>
              <option>Hospitality or guest space</option>
            </select>
          </label>
        </div>
        <label>
          <span>{scopeLabel}</span>
          <input name="scope" type="text" placeholder="A short note on scale, timing, and priorities" required />
        </label>
        <label>
          <span>Message</span>
          <textarea name="message" rows={5} placeholder="Tell us about the property, atmosphere, and what should change." required />
        </label>
        <button type="submit" className="demo-button">Send enquiry</button>
