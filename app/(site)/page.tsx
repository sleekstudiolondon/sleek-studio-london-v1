...
export default function HomePage() {
  return (
    <PageShell
      ...
      hideEyebrow
    >
      <Section narrow center className="homepage-cta-section">
        <div className="button-row homepage-button-row">
      ...
      <Section divider className="homepage-editorial-section">
        <Kicker>Why it matters</Kicker>
        <div className="editorial-split homepage-editorial-split">
          <div className="editorial-column homepage-editorial-column">
            <h2 className="section-title">Perception sets the tone before the first call.</h2>
            <p className="section-copy">
              Your website is usually the first room a client enters. It should feel considered, not crowded, and
              confident without noise.
            </p>
          </div>
          <div className="editorial-column homepage-editorial-column">
            <p className="section-copy">
              We shape each page around pacing and legibility, so the enquiry experience feels precise from opening
              scroll to final submission.
            </p>
      ...
      <Section divider className="homepage-outcomes-section">
        <Kicker>Signature outcomes</Kicker>
        <div className="feature-grid homepage-feature-grid">
          {OUTCOMES.map((item) => (
            <Card key={item.title} className="homepage-outcome-card">
      ...
      <Section narrow center className="homepage-audience-section">
        <Kicker>Designed for</Kicker>
        <h2 className="section-title">Individual designers through to mid-sized studios.</h2>
        <p className="section-copy">
          We work with independent practices, boutique teams, and growing multi-designer studios. When multiple
          profiles are needed, we build a unified structure that keeps every project easy to navigate.
        </p>
